...
const requireHack = !!rootNavigator.userAgent && !!rootNavigator.userAgent.match && !!rootNavigator.userAgent.match(/Safari|AppleWebKit|iPhone|iPod|iPad/gi) && !rootNavigator.userAgent.match(/Windows/gi);
